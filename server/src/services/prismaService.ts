...
export class PrismaService {
    ...
    public async getCandidatesByInterviewLink(linkId: number) {
        ...
        return interviews.map(interview => ({
            ...
            detailedAnswers: interview.detailed_answers ? JSON.parse(interview.detailed_answers) : [],
            questionAnalysis: interview.question_analysis ? JSON.parse(interview.question_analysis) : [],
        }));
    }
    ...
    public async saveInterviewSummary(summary: any) {
        ...
        const data = {
            ...
            detailed_answers: JSON.stringify(summary.detailedAnswers),
            question_analysis: JSON.stringify(summary.questionAnalysis),
