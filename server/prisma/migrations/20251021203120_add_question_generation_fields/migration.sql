...
INSERT INTO "new_interview_links" ("created_at", "created_by", "description", "expiry_date", "id", "is_active", "job_id", "job_title", "link_token", "machine_questions", "max_attempts", "max_interview_questions", "max_machine_coding_questions", "role", "title", "topics", "updated_at", "years_of_experience") SELECT "created_at", "created_by", "description", "expiry_date", "id", "is_active", "job_id", "job_title", "link_token", "machine_questions", "max_attempts", "max_interview_questions", "max_machine_coding_questions", "role", "title", "topics", "updated_at", "years_of_experience" FROM "interview_links";
