...
export const DetailedFeedbackSheet: React.FC<DetailedFeedbackSheetProps> = ({
  ...
  const containerHorizontalPadding = screens.xl ? spacing.xxl * 2.5 : spacing.xxl;
  const containerVerticalPadding = screens.xl ? spacing.xxl : spacing.md;
  ...
  return (
    <div style={{ paddingRight: containerHorizontalPadding, paddingLeft: containerHorizontalPadding, paddingTop: containerVerticalPadding, paddingBottom: containerVerticalPadding, background: '#f5f5f5', minHeight: '100vh' }}>
      {/* Header */}
      <Card
        style={{
            ...
            <Col xs={24} sm={12} md={6}>
              <div style={{ textAlign: 'center', padding: spacing.md, background: '#fafafa', borderRadius: 8 }}>
                <div style={{ fontSize: 32, fontWeight: 700, color: colors.neutral[700], marginBottom: spacing.xs }}>
                  ...
                  {(evaluation.summaryStatistics.averageTimePerQuestion / 60).toFixed(1)}m
                </div>
